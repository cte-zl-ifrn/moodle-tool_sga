...
$string['auth_token_header_desc'] = 'Qual será o token utilizado pelo SGA para se autenticar nesta instalação do Moodle';
$string["auth_token"] = 'SGA auth token';
$string["auth_token_desc"] = 'Qual será o token utilizado pelo SGA para se autenticar nesta instalação do Moodle';
...
$string["default_student_auth_desc"] = 'Recomendamos que você configure oAuth com SOAP, mas... as escolhas são suas. Mas por que oauth? Porque seus alunos podem usufruir do portal SSO e AVA para SGA.';
...
$string["default_student_enrol_type_desc"] = 'Normalmente manuais. Por que? Porque os novos alunos serão matriculados no SGA e sincronizados com o Moodle';

$string["default_teacher_auth"] = 'Autenticação de método padrão para novos usuários professores';
$string["default_teacher_auth_desc"] = 'Recomendamos que você configure oAuth com SOAP, mas... as escolhas são suas. Mas por que oauth? Porque seus alunos podem usufruir do portal SSO e AVA para SGA.';
...
$string["default_teacher_enrol_type_desc"] = 'Normalmente manuais. Por que? Porque os novos alunos serão matriculados no SGA e sincronizados com o Moodle';

$string["default_assistant_auth"] = 'Autenticação de método padrão para novos usuários tutores';
$string["default_assistant_auth_desc"] = 'Recomendamos que você configure oAuth com SOAP, mas... as escolhas são suas. Mas por que oauth? Porque seus alunos podem usufruir do portal SSO e AVA para SGA.';
...
$string["default_assistant_enrol_type_desc"] = 'Normalmente manuais. Por que? Porque os novos alunos serão matriculados no SGA e sincronizados com o Moodle';

$string["default_instructor_auth"] = 'Autenticação de método padrão para novos usuários moderadores em salas de coordenação';
$string["default_instructor_auth_desc"] = 'Recomendamos que você configure oAuth com SOAP, mas... as escolhas são suas. Mas por que oauth? Porque seus alunos podem usufruir do portal SSO e AVA para SGA.';
...
$string["default_instructor_enrol_type_desc"] = 'Normalmente manuais. Por que? Porque os novos moderadores em salas de coordenação serão matriculados no SGA e sincronizados com o Moodle';
