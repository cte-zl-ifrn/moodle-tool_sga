...
$string['pluginname'] = 'SGA Integration';
$string['sga:adminview'] = 'Ver o admin do SGA';


# Auth token
$string['auth_token_header'] = 'Authentication token';
$string['auth_token_header_desc'] = 'Which will be the token used by SGA to authenticate itself to this Moodle installation';
$string["auth_token"] = 'SGA auth token';
$string["auth_token_desc"] = 'Which will be the token used by SGA to authenticate itself to this Moodle installation';
...
$string["default_student_auth_desc"] = 'We recommend that you configure oAuth with SOAP, but... the choices are yours. But why oauth? Because your students can take advantage of the SSO and Painel AVA for SGA.';
...
$string["default_student_enrol_type_desc"] = 'Normally manual. Why? Because new students will be enrolled -manually- on SGA and synched to Moodle';

$string["default_inactivated_student_auth"] = 'Default method authentication for inactivated student users';
$string["default_inactivated_student_auth_desc"] = 'We recommend that you configure oAuth with SOAP, but... the choices are yours. But why oauth? Because your students can take advantage of the SSO and Painel AVA for SGA.';
...
$string["default_inactivated_student_enrol_type_desc"] = 'Normally manual. Why? Because inactivated students will be enrolled -manually- on SGA and synched to Moodle';

$string["default_teacher_auth"] = 'Default method authentication for new teacher users';
$string["default_teacher_auth_desc"] = 'We recommend that you configure oAuth with SOAP, but... the choices are yours. But why oauth? Because your teachers can take advantage of the SSO and Painel AVA for SGA.';
...
$string["default_teacher_enrol_type_desc"] = 'Normally manual. Why? Because new teachers will be enrolled -manually- on SGA and synched to Moodle';

$string["default_assistant_auth"] = 'Default method authentication for new assistant users';
$string["default_assistant_auth_desc"] = 'We recommend that you configure oAuth with SOAP, but... the choices are yours. But why oauth? Because your assistants can take advantage of the SSO and Painel AVA for SGA.';
...
$string["default_assistant_enrol_type_desc"] = 'Normally manual. Why? Because new assistants will be enrolled -manually- on SGA and synched to Moodle';

$string["default_instructor_auth"] = 'Default method authentication for new instructor users';
$string["default_instructor_auth_desc"] = 'We recommend that you configure oAuth with SOAP, but... the choices are yours. But why oauth? Because your instructors can take advantage of the SSO and Painel AVA for SGA.';
...
$string["default_instructor_enrol_type_desc"] = 'Normally manual. Why? Because new instructors will be enrolled -manually- on SGA and synched to Moodle';
